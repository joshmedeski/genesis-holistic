...
add_action( 'tgmpa_register', 'jm_amyjobeaver_register_required_plugins' );
/**
 ...
 */
function jm_amyjobeaver_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/plugins/genesis-simple-share.zip',
            'force_activation'   => true,
            'required'           => true
        ),
        array(
